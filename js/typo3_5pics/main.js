...
$(document).ready(function(){
	...
	if ($('#top-slider').length > 0) {
		...
		// Simulate a link when a user clicks on the button in the slider
		// There is no point in stopping the slider here, because the
		// user may come back to this page
